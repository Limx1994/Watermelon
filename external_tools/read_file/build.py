#!/usr/bin/env python
"""Build script for read_file.exe using PyInstaller."""
...
def main():
    spec_file = Path(__file__).parent / "read_file.spec"
    ...
    exe_path = dist_dir / "read_file.exe"
